...
echo "make clean; ./configure --enable-all-engines --disable-engine=testbed --enable-verbose-build --host=android-x86 --enable-debug --disable-mt32emu"
echo "make -j$(nproc) && mv ScummVM-debug.apk SScummVM-debug-android-x86.apk"
